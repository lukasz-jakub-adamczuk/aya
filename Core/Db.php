...
class Db extends Singleton {
    ...
    private $_res_type = PDO::FETCH_ASSOC;
    ...
    private function __construct($aConfig) {
        ...
        $this->_database = new PDO(
            'mysql:host='.$aConfig['host'].';dbname='.$aConfig['database'].';charset=utf8',  
            $aConfig['user'],
            $aConfig['password'],
            array(  
    ...
    public function fetchRow($rs = null) {
        if($rs === null) {
            ...
            $result = $this->_res->fetch($this->_res_type);
            return $result;
        } else {
    ...
    public function error() { 
        ...
        //     break;
        // }
        print_r($this->_database->errorInfo());
    }
